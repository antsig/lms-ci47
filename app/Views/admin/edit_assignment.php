...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="fw-bold">Edit Assignment: <?= esc($assignment['title']) ?> (Admin Mode)</h4>
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?= base_url('/admin/update-assignment/' . $assignment['id']) ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="mb-3">
