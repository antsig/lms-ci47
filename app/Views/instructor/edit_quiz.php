...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="fw-bold">Edit Quiz: <?= esc($quiz['title']) ?></h4>
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?= base_url('/instructor/update-quiz/' . $quiz['id']) ?>" method="POST">
                    <?= csrf_field() ?>
                    <div class="mb-3">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="q<?= $question['id'] ?>" class="accordion-collapse collapse" data-bs-parent="#questionsAccordion">
                                    <div class="accordion-body">
                                        ...
                                        <a href="<?= base_url('/instructor/quiz/delete-question/' . $question['id']) ?>" 
...
<div class="modal fade" id="addQuestionModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('/instructor/quiz/add-question/' . $quiz['id']) ?>" method="POST">
                <?= csrf_field() ?>
