            ...
            <div class="card-body">
                <div class="tab-content" id="editCourseTabContent">
                                                        ...
                                                        <?php foreach ($section['lessons'] as $lesson): ?>
                                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <button class="btn btn-sm btn-outline-danger ms-2"><i class="fas fa-trash"></i></button>
                                                                </div>
                                                            </li>
                                                        <?php endforeach; ?>
                                                    <?php else: ?>
                                                        ...
                                                        <?php foreach ($section['quizzes'] as $quiz): ?>
                                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <a href="<?= base_url('/instructor/edit-quiz/' . $quiz['id']) ?>" class="btn btn-sm btn-outline-primary ms-2"><i class="fas fa-edit"></i></a>
                                                                    <a href="<?= base_url('/instructor/delete-quiz/' . $quiz['id']) ?>" class="btn btn-sm btn-outline-danger ms-1" onclick="return confirm('Delete quiz?')"><i class="fas fa-trash"></i></a>
                                                                </div>
                                                            </li>
                                                        <?php endforeach; ?>
                                                    <?php endif; ?>
                                                        ...
                                                        <?php foreach ($section['assignments'] as $assignment): ?>
                                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <a href="<?= base_url('/instructor/edit-assignment/' . $assignment['id']) ?>" class="btn btn-sm btn-outline-primary ms-2"><i class="fas fa-edit"></i></a>
                                                                    <a href="<?= base_url('/instructor/delete-assignment/' . $assignment['id']) ?>" class="btn btn-sm btn-outline-danger ms-1" onclick="return confirm('Delete assignment?')"><i class="fas fa-trash"></i></a>
                                                                </div>
                                                            </li>
                                                        <?php endforeach; ?>
                                                    <?php endif; ?>
                    ...
                    <div class="tab-pane fade" id="settings" role="tabpanel">
                        <form action="<?= base_url('/instructor/update-course/' . $course['id']) ?>" method="POST" enctype="multipart/form-data">
                            <?= csrf_field() ?>
...
<div class="modal fade" id="addSectionModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('/instructor/add-section/' . $course['id']) ?>" method="POST">
                <?= csrf_field() ?>
...
<div class="modal fade" id="addLessonModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('/instructor/add-lesson/' . $course['id'] . '/0') ?>" method="POST" id="addLessonForm" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal fade" id="addQuizModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('/instructor/add-quiz/' . $course['id'] . '/0') ?>" method="POST" id="addQuizForm">
                <?= csrf_field() ?>
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal fade" id="addAssignmentModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('/instructor/add-assignment/' . $course['id'] . '/0') ?>" method="POST" id="addAssignmentForm" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="modal-body">
                    <div class="mb-3">
